        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-gray-900">EscolaAgenda</span>
            </div>
            <Link
              to="/login"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 leading-tight mb-6">
                ...
                <span className="text-blue-600">agendas inteligentes</span>
              </h1>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-blue-50 to-gray-50 rounded-2xl p-8 shadow-xl">
                <ImageWithFallback
              ...
              <motion.div
                ...
                className="absolute -left-4 top-1/4 bg-white rounded-lg shadow-lg p-4 hidden lg:block"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Hoje às 14h</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -right-4 bottom-1/4 bg-white rounded-lg shadow-lg p-4 hidden lg:block"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">3 notificações</p>
                    <p className="text-xs text-gray-500">Novos eventos</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                ...
                <span className="text-blue-600">trabalha por você</span>
              </h2>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900">Calendário Escolar</h3>
                  <p className="text-gray-600">Visão mensal completa com todos os eventos</p>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900">Agenda do Professor</h3>
                    <p className="text-gray-600 text-sm">Próximas atividades</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                      <div className="text-sm font-medium text-blue-600 min-w-[60px]">{event.time}</div>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900">Painel da Direção</h3>
                    <p className="text-gray-600 text-sm">Visão geral da escola</p>
                  </div>
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-3 px-10 py-5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-lg font-medium"
            >
              Acessar Plataforma
